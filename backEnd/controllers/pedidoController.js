...
export async function putItemPedido(req, res) {
    ...
    try {
        ...
        const dataLimite = new Date(pedido.criado_em)
        dataLimite.setHours(16, 0, 0, 0) // 16:00 do dia do pedido
        ...
        if (
            ...
            return res.status(403).json({ error: 'Pedido só pode ser editado até as 16h do dia em que foi feito.' })
        }
